...
3. Place a jukebox, insert a music disc, and move the Observer within six blocks. Confirm it begins bobbing, swaying, occasionally spinning, and shedding note particles within about half a second. Move beyond the range and confirm it stops, then return and confirm it resumes. Eject the disc and confirm dancing stops; a jukebox that merely contains a finished disc must not keep it dancing.
